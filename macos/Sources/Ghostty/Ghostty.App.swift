...
extension Ghostty {
    ...
    class App: ObservableObject {
        ...
        static func action(_ app: ghostty_app_t, target: ghostty_target_s, action: ghostty_action_s) -> Bool {
            ...
            case GHOSTTY_ACTION_TOGGLE_FILE_BROWSER:
                toggleFileBrowser(app, target: target)
        ...
        private static func toggleFileBrowser(
            _ app: ghostty_app_t,
            target: ghostty_target_s) {
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Ghostty.logger.warning("toggle file browser does nothing with an app target")
                return
